    ...
    import CreateWorkoutPanel from '../components/workout/WorkoutEditor';
    ...
    import TimerControls from '../components/player/TimerControls';
    import TimerDisplay, { formatTime } from '../components/player/TimerDisplay';
...
const PlayerPage: React.FC<WorkoutPlayerProps> = ({
